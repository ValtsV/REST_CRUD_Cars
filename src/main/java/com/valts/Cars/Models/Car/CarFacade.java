...
public class CarFacade {
    ...
    public Car getGasCar(String modelName, int doorCount, String color){
        ...
        return new GasCar(modelName, doorCount, color, supercharger, petrolTank, ice);
    }

    public Car getHybridCar(String modelName, int doorCount, String color){
        Supercharger supercharger = new Supercharger(true, 2d);
        ...
        return new HydrogenCar(modelName, doorCount, color, supercharger, hydrogenTank, ice, lithiumBattery, pec);
    }

    public Car getElectricCar(String modelName, int doorCount, String color) {
        ...
        return new ElectricCar(modelName, doorCount, color, lithiumBattery, electricMotor, pec);
    }
